...
def execQuery(args):
  ...
  labels, results = getLogs(startDate, endDate, 
                            ...
                            sortOrder=sortOrder)
  if not noHeaders:
    print("MONTHLY USER LISTS FOR PERIOD: " + args.begin_date + " - " + args.end_date)
...
def createMonthlyUserListsParser(subParser):
  descriptionStr = \
"""Print the list of unique monthly users for a given package in the given date range"""
  exampleStr = \
"""Examples:
-- number of unique users of R from January to February, 2015:
   ./module-query monthly-user-lists -b 01/2015 -e 02/2015 --module R"""
...
--tab_separators"""
  ...
  queryParser = subParser.add_parser("monthly-user-lists",
